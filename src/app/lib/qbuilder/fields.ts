...
export const fields = [
  ...
  { group: FieldGroups.Common, name: "Account", label: "Account (Sender)", inputType: "string", placeholder: "Enter sending account", defaultOperator: "=", operators: validOperators(ACCOUNT_OPERATORS), },
  ...
  { group: FieldGroups.Common, name: "Destination", label: "Destination (Receiver)", inputType: "string", placeholder: "Enter destination", defaultOperator: "=", operators: validOperators(ACCOUNT_OPERATORS),},
